...
typedef unsigned int GLhandleARB;
		...
		//GL_STACK_OVERFLOW already defined in KHR_debug (0x0503)
		//GL_STACK_UNDERFLOW already defined in KHR_debug (0x0504)
		...
		//GL_VERTEX_ARRAY already defined in KHR_debug (0x8074)
		...
		// Version: 4.1
		//GL_ACTIVE_PROGRAM already defined in ARB_separate_shader_objects (0x8259)
		//GL_ALL_SHADER_BITS already defined in ARB_separate_shader_objects (0xFFFFFFFF)
		//GL_FIXED already defined in ARB_ES2_compatibility (0x140C)
		//GL_FRAGMENT_SHADER_BIT already defined in ARB_separate_shader_objects (0x00000002)
		//GL_GEOMETRY_SHADER_BIT already defined in ARB_separate_shader_objects (0x00000004)
		//GL_HIGH_FLOAT already defined in ARB_ES2_compatibility (0x8DF2)
		//GL_HIGH_INT already defined in ARB_ES2_compatibility (0x8DF5)
		//GL_IMPLEMENTATION_COLOR_READ_FORMAT already defined in ARB_ES2_compatibility (0x8B9B)
		//GL_IMPLEMENTATION_COLOR_READ_TYPE already defined in ARB_ES2_compatibility (0x8B9A)
		//GL_LAYER_PROVOKING_VERTEX already defined in ARB_viewport_array (0x825E)
		//GL_LOW_FLOAT already defined in ARB_ES2_compatibility (0x8DF0)
		//GL_LOW_INT already defined in ARB_ES2_compatibility (0x8DF3)
		//GL_MAX_FRAGMENT_UNIFORM_VECTORS already defined in ARB_ES2_compatibility (0x8DFD)
		//GL_MAX_VARYING_VECTORS already defined in ARB_ES2_compatibility (0x8DFC)
		//GL_MAX_VERTEX_UNIFORM_VECTORS already defined in ARB_ES2_compatibility (0x8DFB)
		//GL_MAX_VIEWPORTS already defined in ARB_viewport_array (0x825B)
		//GL_MEDIUM_FLOAT already defined in ARB_ES2_compatibility (0x8DF1)
		//GL_MEDIUM_INT already defined in ARB_ES2_compatibility (0x8DF4)
		//GL_NUM_PROGRAM_BINARY_FORMATS already defined in ARB_get_program_binary (0x87FE)
		//GL_NUM_SHADER_BINARY_FORMATS already defined in ARB_ES2_compatibility (0x8DF9)
		//GL_PROGRAM_BINARY_FORMATS already defined in ARB_get_program_binary (0x87FF)
		//GL_PROGRAM_BINARY_LENGTH already defined in ARB_get_program_binary (0x8741)
		//GL_PROGRAM_BINARY_RETRIEVABLE_HINT already defined in ARB_get_program_binary (0x8257)
		//GL_PROGRAM_PIPELINE_BINDING already defined in ARB_separate_shader_objects (0x825A)
		//GL_PROGRAM_SEPARABLE already defined in ARB_separate_shader_objects (0x8258)
		//GL_RGB565 already defined in ARB_ES2_compatibility (0x8D62)
		//GL_SHADER_BINARY_FORMATS already defined in ARB_ES2_compatibility (0x8DF8)
		//GL_SHADER_COMPILER already defined in ARB_ES2_compatibility (0x8DFA)
		//GL_TESS_CONTROL_SHADER_BIT already defined in ARB_separate_shader_objects (0x00000008)
		//GL_TESS_EVALUATION_SHADER_BIT already defined in ARB_separate_shader_objects (0x00000010)
		//GL_UNDEFINED_VERTEX already defined in ARB_viewport_array (0x8260)
		//GL_VERTEX_SHADER_BIT already defined in ARB_separate_shader_objects (0x00000001)
		//GL_VIEWPORT_BOUNDS_RANGE already defined in ARB_viewport_array (0x825D)
		//GL_VIEWPORT_INDEX_PROVOKING_VERTEX already defined in ARB_viewport_array (0x825F)
		//GL_VIEWPORT_SUBPIXEL_BITS already defined in ARB_viewport_array (0x825C)
		
		// Version: 4.2
		#define GL_ACTIVE_ATOMIC_COUNTER_BUFFERS 0x92D9
		#define GL_ALL_BARRIER_BITS              0xFFFFFFFF
		#define GL_ATOMIC_COUNTER_BARRIER_BIT    0x00001000
		//GL_ATOMIC_COUNTER_BUFFER already defined in ARB_program_interface_query (0x92C0)
		...
		//GL_IMAGE_FORMAT_COMPATIBILITY_TYPE already defined in ARB_internalformat_query2 (0x90C7)
		...
		//GL_MIN_MAP_BUFFER_ALIGNMENT already defined in ARB_map_buffer_alignment (0x90BC)
		//GL_NUM_SAMPLE_COUNTS already defined in ARB_internalformat_query2 (0x9380)
		//GL_PACK_COMPRESSED_BLOCK_DEPTH already defined in ARB_compressed_texture_pixel_storage (0x912D)
		//GL_PACK_COMPRESSED_BLOCK_HEIGHT already defined in ARB_compressed_texture_pixel_storage (0x912C)
		//GL_PACK_COMPRESSED_BLOCK_SIZE already defined in ARB_compressed_texture_pixel_storage (0x912E)
		//GL_PACK_COMPRESSED_BLOCK_WIDTH already defined in ARB_compressed_texture_pixel_storage (0x912B)
		#define GL_PIXEL_BUFFER_BARRIER_BIT      0x00000080
		#define GL_SHADER_IMAGE_ACCESS_BARRIER_BIT 0x00000020
		#define GL_TEXTURE_FETCH_BARRIER_BIT     0x00000008
		//GL_TEXTURE_IMMUTABLE_FORMAT already defined in ARB_texture_storage (0x912F)
		#define GL_TEXTURE_UPDATE_BARRIER_BIT    0x00000100
		#define GL_TRANSFORM_FEEDBACK_BARRIER_BIT 0x00000800
		#define GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX 0x92DA
		#define GL_UNIFORM_BARRIER_BIT           0x00000004
		//GL_UNPACK_COMPRESSED_BLOCK_DEPTH already defined in ARB_compressed_texture_pixel_storage (0x9129)
		//GL_UNPACK_COMPRESSED_BLOCK_HEIGHT already defined in ARB_compressed_texture_pixel_storage (0x9128)
		//GL_UNPACK_COMPRESSED_BLOCK_SIZE already defined in ARB_compressed_texture_pixel_storage (0x912A)
		//GL_UNPACK_COMPRESSED_BLOCK_WIDTH already defined in ARB_compressed_texture_pixel_storage (0x9127)
		...
		// Version: 4.3
		//GL_ACTIVE_RESOURCES already defined in ARB_program_interface_query (0x92F5)
		//GL_ACTIVE_VARIABLES already defined in ARB_program_interface_query (0x9305)
		//GL_ANY_SAMPLES_PASSED_CONSERVATIVE already defined in ARB_ES3_compatibility (0x8D6A)
		//GL_ARRAY_SIZE already defined in ARB_program_interface_query (0x92FB)
		//GL_ARRAY_STRIDE already defined in ARB_program_interface_query (0x92FE)
		//GL_ATOMIC_COUNTER_BUFFER_INDEX already defined in ARB_program_interface_query (0x9301)
		//GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHADER already defined in ARB_compute_shader (0x90ED)
		//GL_AUTO_GENERATE_MIPMAP already defined in ARB_internalformat_query2 (0x8295)
		//GL_BLOCK_INDEX already defined in ARB_program_interface_query (0x92FD)
		//GL_BUFFER already defined in KHR_debug (0x82E0)
		//GL_BUFFER_BINDING already defined in ARB_program_interface_query (0x9302)
		//GL_BUFFER_DATA_SIZE already defined in ARB_program_interface_query (0x9303)
		//GL_BUFFER_VARIABLE already defined in ARB_program_interface_query (0x92E5)
		//GL_CAVEAT_SUPPORT already defined in ARB_internalformat_query2 (0x82B8)
		//GL_CLEAR_BUFFER already defined in ARB_internalformat_query2 (0x82B4)
		//GL_COLOR_COMPONENTS already defined in ARB_internalformat_query2 (0x8283)
		//GL_COLOR_ENCODING already defined in ARB_internalformat_query2 (0x8296)
		//GL_COLOR_RENDERABLE already defined in ARB_internalformat_query2 (0x8286)
		//GL_COMPRESSED_R11_EAC already defined in ARB_ES3_compatibility (0x9270)
		//GL_COMPRESSED_RG11_EAC already defined in ARB_ES3_compatibility (0x9272)
		//GL_COMPRESSED_RGB8_ETC2 already defined in ARB_ES3_compatibility (0x9274)
		//GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2 already defined in ARB_ES3_compatibility (0x9276)
		//GL_COMPRESSED_RGBA8_ETC2_EAC already defined in ARB_ES3_compatibility (0x9278)
		//GL_COMPRESSED_SIGNED_R11_EAC already defined in ARB_ES3_compatibility (0x9271)
		//GL_COMPRESSED_SIGNED_RG11_EAC already defined in ARB_ES3_compatibility (0x9273)
		//GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC already defined in ARB_ES3_compatibility (0x9279)
		//GL_COMPRESSED_SRGB8_ETC2 already defined in ARB_ES3_compatibility (0x9275)
		//GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2 already defined in ARB_ES3_compatibility (0x9277)
		//GL_COMPUTE_LOCAL_WORK_SIZE already defined in ARB_compute_shader (0x8267)
		//GL_COMPUTE_SHADER already defined in ARB_compute_shader (0x91B9)
		//GL_COMPUTE_SUBROUTINE already defined in ARB_program_interface_query (0x92ED)
		//GL_COMPUTE_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92F3)
		//GL_COMPUTE_TEXTURE already defined in ARB_internalformat_query2 (0x82A0)
		//GL_CONTEXT_FLAG_DEBUG_BIT already defined in KHR_debug (0x00000002)
		//GL_DEBUG_CALLBACK_FUNCTION already defined in KHR_debug (0x8244)
		//GL_DEBUG_CALLBACK_USER_PARAM already defined in KHR_debug (0x8245)
		//GL_DEBUG_GROUP_STACK_DEPTH already defined in KHR_debug (0x826D)
		//GL_DEBUG_LOGGED_MESSAGES already defined in KHR_debug (0x9145)
		//GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH already defined in KHR_debug (0x8243)
		//GL_DEBUG_OUTPUT already defined in KHR_debug (0x92E0)
		//GL_DEBUG_OUTPUT_SYNCHRONOUS already defined in KHR_debug (0x8242)
		//GL_DEBUG_SEVERITY_HIGH already defined in KHR_debug (0x9146)
		//GL_DEBUG_SEVERITY_LOW already defined in KHR_debug (0x9148)
		//GL_DEBUG_SEVERITY_MEDIUM already defined in KHR_debug (0x9147)
		//GL_DEBUG_SEVERITY_NOTIFICATION already defined in KHR_debug (0x826B)
		//GL_DEBUG_SOURCE_API already defined in KHR_debug (0x8246)
		//GL_DEBUG_SOURCE_APPLICATION already defined in KHR_debug (0x824A)
		//GL_DEBUG_SOURCE_OTHER already defined in KHR_debug (0x824B)
		//GL_DEBUG_SOURCE_SHADER_COMPILER already defined in KHR_debug (0x8248)
		//GL_DEBUG_SOURCE_THIRD_PARTY already defined in KHR_debug (0x8249)
		//GL_DEBUG_SOURCE_WINDOW_SYSTEM already defined in KHR_debug (0x8247)
		//GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR already defined in KHR_debug (0x824D)
		//GL_DEBUG_TYPE_ERROR already defined in KHR_debug (0x824C)
		//GL_DEBUG_TYPE_MARKER already defined in KHR_debug (0x8268)
		//GL_DEBUG_TYPE_OTHER already defined in KHR_debug (0x8251)
		//GL_DEBUG_TYPE_PERFORMANCE already defined in KHR_debug (0x8250)
		//GL_DEBUG_TYPE_POP_GROUP already defined in KHR_debug (0x826A)
		//GL_DEBUG_TYPE_PORTABILITY already defined in KHR_debug (0x824F)
		//GL_DEBUG_TYPE_PUSH_GROUP already defined in KHR_debug (0x8269)
		//GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR already defined in KHR_debug (0x824E)
		//GL_DEPTH_COMPONENTS already defined in ARB_internalformat_query2 (0x8284)
		//GL_DEPTH_RENDERABLE already defined in ARB_internalformat_query2 (0x8287)
		//GL_DEPTH_STENCIL_TEXTURE_MODE already defined in ARB_stencil_texturing (0x90EA)
		//GL_DISPATCH_INDIRECT_BUFFER already defined in ARB_compute_shader (0x90EE)
		//GL_DISPATCH_INDIRECT_BUFFER_BINDING already defined in ARB_compute_shader (0x90EF)
		//GL_FILTER already defined in ARB_internalformat_query2 (0x829A)
		//GL_FRAGMENT_SUBROUTINE already defined in ARB_program_interface_query (0x92EC)
		//GL_FRAGMENT_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92F2)
		//GL_FRAGMENT_TEXTURE already defined in ARB_internalformat_query2 (0x829F)
		//GL_FRAMEBUFFER_BLEND already defined in ARB_internalformat_query2 (0x828B)
		//GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS already defined in ARB_framebuffer_no_attachments (0x9314)
		//GL_FRAMEBUFFER_DEFAULT_HEIGHT already defined in ARB_framebuffer_no_attachments (0x9311)
		//GL_FRAMEBUFFER_DEFAULT_LAYERS already defined in ARB_framebuffer_no_attachments (0x9312)
		//GL_FRAMEBUFFER_DEFAULT_SAMPLES already defined in ARB_framebuffer_no_attachments (0x9313)
		//GL_FRAMEBUFFER_DEFAULT_WIDTH already defined in ARB_framebuffer_no_attachments (0x9310)
		//GL_FRAMEBUFFER_RENDERABLE already defined in ARB_internalformat_query2 (0x8289)
		//GL_FRAMEBUFFER_RENDERABLE_LAYERED already defined in ARB_internalformat_query2 (0x828A)
		//GL_FULL_SUPPORT already defined in ARB_internalformat_query2 (0x82B7)
		//GL_GEOMETRY_SUBROUTINE already defined in ARB_program_interface_query (0x92EB)
		//GL_GEOMETRY_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92F1)
		//GL_GEOMETRY_TEXTURE already defined in ARB_internalformat_query2 (0x829E)
		//GL_GET_TEXTURE_IMAGE_FORMAT already defined in ARB_internalformat_query2 (0x8291)
		//GL_GET_TEXTURE_IMAGE_TYPE already defined in ARB_internalformat_query2 (0x8292)
		//GL_IMAGE_CLASS_10_10_10_2 already defined in ARB_internalformat_query2 (0x82C3)
		//GL_IMAGE_CLASS_11_11_10 already defined in ARB_internalformat_query2 (0x82C2)
		//GL_IMAGE_CLASS_1_X_16 already defined in ARB_internalformat_query2 (0x82BE)
		//GL_IMAGE_CLASS_1_X_32 already defined in ARB_internalformat_query2 (0x82BB)
		//GL_IMAGE_CLASS_1_X_8 already defined in ARB_internalformat_query2 (0x82C1)
		//GL_IMAGE_CLASS_2_X_16 already defined in ARB_internalformat_query2 (0x82BD)
		//GL_IMAGE_CLASS_2_X_32 already defined in ARB_internalformat_query2 (0x82BA)
		//GL_IMAGE_CLASS_2_X_8 already defined in ARB_internalformat_query2 (0x82C0)
		//GL_IMAGE_CLASS_4_X_16 already defined in ARB_internalformat_query2 (0x82BC)
		//GL_IMAGE_CLASS_4_X_32 already defined in ARB_internalformat_query2 (0x82B9)
		//GL_IMAGE_CLASS_4_X_8 already defined in ARB_internalformat_query2 (0x82BF)
		//GL_IMAGE_COMPATIBILITY_CLASS already defined in ARB_internalformat_query2 (0x82A8)
		//GL_IMAGE_PIXEL_FORMAT already defined in ARB_internalformat_query2 (0x82A9)
		//GL_IMAGE_PIXEL_TYPE already defined in ARB_internalformat_query2 (0x82AA)
		//GL_IMAGE_TEXEL_SIZE already defined in ARB_internalformat_query2 (0x82A7)
		//GL_INTERNALFORMAT_ALPHA_SIZE already defined in ARB_internalformat_query2 (0x8274)
		//GL_INTERNALFORMAT_ALPHA_TYPE already defined in ARB_internalformat_query2 (0x827B)
		//GL_INTERNALFORMAT_BLUE_SIZE already defined in ARB_internalformat_query2 (0x8273)
		//GL_INTERNALFORMAT_BLUE_TYPE already defined in ARB_internalformat_query2 (0x827A)
		//GL_INTERNALFORMAT_DEPTH_SIZE already defined in ARB_internalformat_query2 (0x8275)
		//GL_INTERNALFORMAT_DEPTH_TYPE already defined in ARB_internalformat_query2 (0x827C)
		//GL_INTERNALFORMAT_GREEN_SIZE already defined in ARB_internalformat_query2 (0x8272)
		//GL_INTERNALFORMAT_GREEN_TYPE already defined in ARB_internalformat_query2 (0x8279)
		//GL_INTERNALFORMAT_PREFERRED already defined in ARB_internalformat_query2 (0x8270)
		//GL_INTERNALFORMAT_RED_SIZE already defined in ARB_internalformat_query2 (0x8271)
		//GL_INTERNALFORMAT_RED_TYPE already defined in ARB_internalformat_query2 (0x8278)
		//GL_INTERNALFORMAT_SHARED_SIZE already defined in ARB_internalformat_query2 (0x8277)
		//GL_INTERNALFORMAT_STENCIL_SIZE already defined in ARB_internalformat_query2 (0x8276)
		//GL_INTERNALFORMAT_STENCIL_TYPE already defined in ARB_internalformat_query2 (0x827D)
		//GL_INTERNALFORMAT_SUPPORTED already defined in ARB_internalformat_query2 (0x826F)
		//GL_IS_PER_PATCH already defined in ARB_program_interface_query (0x92E7)
		//GL_IS_ROW_MAJOR already defined in ARB_program_interface_query (0x9300)
		//GL_LOCATION already defined in ARB_program_interface_query (0x930E)
		//GL_LOCATION_INDEX already defined in ARB_program_interface_query (0x930F)
		//GL_MANUAL_GENERATE_MIPMAP already defined in ARB_internalformat_query2 (0x8294)
		//GL_MATRIX_STRIDE already defined in ARB_program_interface_query (0x92FF)
		//GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS already defined in ARB_compute_shader (0x8266)
		//GL_MAX_COMBINED_DIMENSIONS already defined in ARB_internalformat_query2 (0x8282)
		#define GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES 0x8F39
		#define GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS 0x90DC
		//GL_MAX_COMPUTE_ATOMIC_COUNTERS already defined in ARB_compute_shader (0x8265)
		//GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS already defined in ARB_compute_shader (0x8264)
		//GL_MAX_COMPUTE_IMAGE_UNIFORMS already defined in ARB_compute_shader (0x91BD)
		//GL_MAX_COMPUTE_LOCAL_INVOCATIONS already defined in ARB_compute_shader (0x90EB)
		#define GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS 0x90DB
		//GL_MAX_COMPUTE_SHARED_MEMORY_SIZE already defined in ARB_compute_shader (0x8262)
		//GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS already defined in ARB_compute_shader (0x91BC)
		//GL_MAX_COMPUTE_UNIFORM_BLOCKS already defined in ARB_compute_shader (0x91BB)
		//GL_MAX_COMPUTE_UNIFORM_COMPONENTS already defined in ARB_compute_shader (0x8263)
		//GL_MAX_COMPUTE_WORK_GROUP_COUNT already defined in ARB_compute_shader (0x91BE)
		//GL_MAX_COMPUTE_WORK_GROUP_SIZE already defined in ARB_compute_shader (0x91BF)
		//GL_MAX_DEBUG_GROUP_STACK_DEPTH already defined in KHR_debug (0x826C)
		//GL_MAX_DEBUG_LOGGED_MESSAGES already defined in KHR_debug (0x9144)
		//GL_MAX_DEBUG_MESSAGE_LENGTH already defined in KHR_debug (0x9143)
		//GL_MAX_DEPTH already defined in ARB_internalformat_query2 (0x8280)
		//GL_MAX_ELEMENT_INDEX already defined in ARB_ES3_compatibility (0x8D6B)
		#define GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS 0x90DA
		//GL_MAX_FRAMEBUFFER_HEIGHT already defined in ARB_framebuffer_no_attachments (0x9316)
		//GL_MAX_FRAMEBUFFER_LAYERS already defined in ARB_framebuffer_no_attachments (0x9317)
		//GL_MAX_FRAMEBUFFER_SAMPLES already defined in ARB_framebuffer_no_attachments (0x9318)
		//GL_MAX_FRAMEBUFFER_WIDTH already defined in ARB_framebuffer_no_attachments (0x9315)
		#define GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS 0x90D7
		//GL_MAX_HEIGHT already defined in ARB_internalformat_query2 (0x827F)
		//GL_MAX_LABEL_LENGTH already defined in KHR_debug (0x82E8)
		//GL_MAX_LAYERS already defined in ARB_internalformat_query2 (0x8281)
		//GL_MAX_NAME_LENGTH already defined in ARB_program_interface_query (0x92F6)
		//GL_MAX_NUM_ACTIVE_VARIABLES already defined in ARB_program_interface_query (0x92F7)
		//GL_MAX_NUM_COMPATIBLE_SUBROUTINES already defined in ARB_program_interface_query (0x92F8)
		#define GL_MAX_SHADER_STORAGE_BLOCK_SIZE 0x90DE
		#define GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS 0x90DD
		#define GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS 0x90D8
		#define GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS 0x90D9
		//GL_MAX_UNIFORM_LOCATIONS already defined in ARB_explicit_uniform_location (0x826E)
		//GL_MAX_VERTEX_ATTRIB_BINDINGS already defined in ARB_vertex_attrib_binding (0x82DA)
		//GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET already defined in ARB_vertex_attrib_binding (0x82D9)
		#define GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS 0x90D6
		//GL_MAX_WIDTH already defined in ARB_internalformat_query2 (0x827E)
		//GL_MIPMAP already defined in ARB_internalformat_query2 (0x8293)
		//GL_NAME_LENGTH already defined in ARB_program_interface_query (0x92F9)
		//GL_NUM_ACTIVE_VARIABLES already defined in ARB_program_interface_query (0x9304)
		#define GL_NUM_SHADING_LANGUAGE_VERSIONS 0x82E9
		//GL_OFFSET already defined in ARB_program_interface_query (0x92FC)
		//GL_PRIMITIVE_RESTART_FIXED_INDEX already defined in ARB_ES3_compatibility (0x8D69)
		//GL_PROGRAM already defined in KHR_debug (0x82E2)
		//GL_PROGRAM_INPUT already defined in ARB_program_interface_query (0x92E3)
		//GL_PROGRAM_OUTPUT already defined in ARB_program_interface_query (0x92E4)
		//GL_PROGRAM_PIPELINE already defined in KHR_debug (0x82E4)
		//GL_QUERY already defined in KHR_debug (0x82E3)
		//GL_READ_PIXELS already defined in ARB_internalformat_query2 (0x828C)
		//GL_READ_PIXELS_FORMAT already defined in ARB_internalformat_query2 (0x828D)
		//GL_READ_PIXELS_TYPE already defined in ARB_internalformat_query2 (0x828E)
		//GL_REFERENCED_BY_COMPUTE_SHADER already defined in ARB_program_interface_query (0x930B)
		//GL_REFERENCED_BY_FRAGMENT_SHADER already defined in ARB_program_interface_query (0x930A)
		//GL_REFERENCED_BY_GEOMETRY_SHADER already defined in ARB_program_interface_query (0x9309)
		//GL_REFERENCED_BY_TESS_CONTROL_SHADER already defined in ARB_program_interface_query (0x9307)
		//GL_REFERENCED_BY_TESS_EVALUATION_SHADER already defined in ARB_program_interface_query (0x9308)
		//GL_REFERENCED_BY_VERTEX_SHADER already defined in ARB_program_interface_query (0x9306)
		//GL_SAMPLER already defined in KHR_debug (0x82E6)
		//GL_SHADER already defined in KHR_debug (0x82E1)
		//GL_SHADER_IMAGE_ATOMIC already defined in ARB_internalformat_query2 (0x82A6)
		//GL_SHADER_IMAGE_LOAD already defined in ARB_internalformat_query2 (0x82A4)
		//GL_SHADER_IMAGE_STORE already defined in ARB_internalformat_query2 (0x82A5)
		#define GL_SHADER_STORAGE_BARRIER_BIT    0x00002000
		//GL_SHADER_STORAGE_BLOCK already defined in ARB_program_interface_query (0x92E6)
		#define GL_SHADER_STORAGE_BUFFER         0x90D2
		#define GL_SHADER_STORAGE_BUFFER_BINDING 0x90D3
		#define GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT 0x90DF
		#define GL_SHADER_STORAGE_BUFFER_SIZE    0x90D5
		#define GL_SHADER_STORAGE_BUFFER_START   0x90D4
		//GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST already defined in ARB_internalformat_query2 (0x82AC)
		//GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE already defined in ARB_internalformat_query2 (0x82AE)
		//GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST already defined in ARB_internalformat_query2 (0x82AD)
		//GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE already defined in ARB_internalformat_query2 (0x82AF)
		//GL_SRGB_READ already defined in ARB_internalformat_query2 (0x8297)
		//GL_SRGB_WRITE already defined in ARB_internalformat_query2 (0x8298)
		//GL_STENCIL_COMPONENTS already defined in ARB_internalformat_query2 (0x8285)
		//GL_STENCIL_RENDERABLE already defined in ARB_internalformat_query2 (0x8288)
		//GL_TESS_CONTROL_SUBROUTINE already defined in ARB_program_interface_query (0x92E9)
		//GL_TESS_CONTROL_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92EF)
		//GL_TESS_CONTROL_TEXTURE already defined in ARB_internalformat_query2 (0x829C)
		//GL_TESS_EVALUATION_SUBROUTINE already defined in ARB_program_interface_query (0x92EA)
		//GL_TESS_EVALUATION_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92F0)
		//GL_TESS_EVALUATION_TEXTURE already defined in ARB_internalformat_query2 (0x829D)
		//GL_TEXTURE_BUFFER_OFFSET already defined in ARB_texture_buffer_range (0x919D)
		//GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT already defined in ARB_texture_buffer_range (0x919F)
		//GL_TEXTURE_BUFFER_SIZE already defined in ARB_texture_buffer_range (0x919E)
		//GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT already defined in ARB_internalformat_query2 (0x82B2)
		//GL_TEXTURE_COMPRESSED_BLOCK_SIZE already defined in ARB_internalformat_query2 (0x82B3)
		//GL_TEXTURE_COMPRESSED_BLOCK_WIDTH already defined in ARB_internalformat_query2 (0x82B1)
		//GL_TEXTURE_GATHER already defined in ARB_internalformat_query2 (0x82A2)
		//GL_TEXTURE_GATHER_SHADOW already defined in ARB_internalformat_query2 (0x82A3)
		//GL_TEXTURE_IMAGE_FORMAT already defined in ARB_internalformat_query2 (0x828F)
		//GL_TEXTURE_IMAGE_TYPE already defined in ARB_internalformat_query2 (0x8290)
		//GL_TEXTURE_IMMUTABLE_LEVELS already defined in ARB_texture_view (0x82DF)
		//GL_TEXTURE_SHADOW already defined in ARB_internalformat_query2 (0x82A1)
		//GL_TEXTURE_VIEW already defined in ARB_internalformat_query2 (0x82B5)
		//GL_TEXTURE_VIEW_MIN_LAYER already defined in ARB_texture_view (0x82DD)
		//GL_TEXTURE_VIEW_MIN_LEVEL already defined in ARB_texture_view (0x82DB)
		//GL_TEXTURE_VIEW_NUM_LAYERS already defined in ARB_texture_view (0x82DE)
		//GL_TEXTURE_VIEW_NUM_LEVELS already defined in ARB_texture_view (0x82DC)
		//GL_TOP_LEVEL_ARRAY_SIZE already defined in ARB_program_interface_query (0x930C)
		//GL_TOP_LEVEL_ARRAY_STRIDE already defined in ARB_program_interface_query (0x930D)
		//GL_TRANSFORM_FEEDBACK_VARYING already defined in ARB_program_interface_query (0x92F4)
		//GL_TYPE already defined in ARB_program_interface_query (0x92FA)
		//GL_UNIFORM already defined in ARB_program_interface_query (0x92E1)
		//GL_UNIFORM_BLOCK already defined in ARB_program_interface_query (0x92E2)
		//GL_UNIFORM_BLOCK_REFERENCED_BY_COMPUTE_SHADER already defined in ARB_compute_shader (0x90EC)
		#define GL_VERTEX_ATTRIB_ARRAY_LONG      0x874E
		//GL_VERTEX_ATTRIB_BINDING already defined in ARB_vertex_attrib_binding (0x82D4)
		//GL_VERTEX_ATTRIB_RELATIVE_OFFSET already defined in ARB_vertex_attrib_binding (0x82D5)
		//GL_VERTEX_BINDING_DIVISOR already defined in ARB_vertex_attrib_binding (0x82D6)
		//GL_VERTEX_BINDING_OFFSET already defined in ARB_vertex_attrib_binding (0x82D7)
		//GL_VERTEX_BINDING_STRIDE already defined in ARB_vertex_attrib_binding (0x82D8)
		//GL_VERTEX_SUBROUTINE already defined in ARB_program_interface_query (0x92E8)
		//GL_VERTEX_SUBROUTINE_UNIFORM already defined in ARB_program_interface_query (0x92EE)
		//GL_VERTEX_TEXTURE already defined in ARB_internalformat_query2 (0x829B)
		//GL_VIEW_CLASS_128_BITS already defined in ARB_internalformat_query2 (0x82C4)
		//GL_VIEW_CLASS_16_BITS already defined in ARB_internalformat_query2 (0x82CA)
		//GL_VIEW_CLASS_24_BITS already defined in ARB_internalformat_query2 (0x82C9)
		//GL_VIEW_CLASS_32_BITS already defined in ARB_internalformat_query2 (0x82C8)
		//GL_VIEW_CLASS_48_BITS already defined in ARB_internalformat_query2 (0x82C7)
		//GL_VIEW_CLASS_64_BITS already defined in ARB_internalformat_query2 (0x82C6)
		//GL_VIEW_CLASS_8_BITS already defined in ARB_internalformat_query2 (0x82CB)
		//GL_VIEW_CLASS_96_BITS already defined in ARB_internalformat_query2 (0x82C5)
		//GL_VIEW_CLASS_BPTC_FLOAT already defined in ARB_internalformat_query2 (0x82D3)
		//GL_VIEW_CLASS_BPTC_UNORM already defined in ARB_internalformat_query2 (0x82D2)
		//GL_VIEW_CLASS_RGTC1_RED already defined in ARB_internalformat_query2 (0x82D0)
		//GL_VIEW_CLASS_RGTC2_RG already defined in ARB_internalformat_query2 (0x82D1)
		//GL_VIEW_CLASS_S3TC_DXT1_RGB already defined in ARB_internalformat_query2 (0x82CC)
		//GL_VIEW_CLASS_S3TC_DXT1_RGBA already defined in ARB_internalformat_query2 (0x82CD)
		//GL_VIEW_CLASS_S3TC_DXT3_RGBA already defined in ARB_internalformat_query2 (0x82CE)
		//GL_VIEW_CLASS_S3TC_DXT5_RGBA already defined in ARB_internalformat_query2 (0x82CF)
		//GL_VIEW_COMPATIBILITY_CLASS already defined in ARB_internalformat_query2 (0x82B6)
